...
import { contact, BOOKING_URL, social as socialLinks } from '../data/content.js';
...
const social = [
  ['LinkedIn', 'linkedin'], ['YouTube', 'youtube'], ['Instagram', 'instagram'], ['Upwork', 'upwork'],
];
      ...
      <div className="container">
        <div className="sf-grid">
          <div className="sf-brand">
            ...
            <p className="sf-connect">Let&rsquo;s Connect</p>
            <ul className="sf-social" aria-label="Social media">
              {social.map(([label, key]) => (
                <li key={key}><a className={'is-' + key} href={socialLinks[key]} target="_blank" rel="noopener noreferrer" aria-label={label} title={label}><svg viewBox="0 0 24 24">{Icon[key]}</svg></a></li>
              ))}
            </ul>
          </div>
