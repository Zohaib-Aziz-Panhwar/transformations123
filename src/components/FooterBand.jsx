...
export default function FooterBand() {
  return (
    <footer className="footer-band">
      <div className="footer-swoosh" aria-hidden="true"><img src="/assets/images/footer-swoosh.jpg" alt="" /></div>
      <div className="container footer-inner">
        <span className="footer-butterfly" aria-hidden="true"><img src="/assets/images/footer-butterfly.png" alt="" /></span>
